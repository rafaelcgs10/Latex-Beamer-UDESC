...
programas e aplicar durante todo o processo evolucionário causaria um considerável aumento de tempo da
evolução.
\end{frame}
...
temporariamente completados com \mintinline{haskell}{ARG}s)
    ...
    \end{itemize}
    \begin{enumerate}
    \item \mintinline[fontsize=\small]{haskell}{ARG::[G2]}.
    \item \mintinline[fontsize=\small, breaklines]{haskell}{if::Bool->[G2]->[G2]->[G2]}.
    \item \mintinline[fontsize=\small, breaklines]{haskell}{(((if ARG::Bool) ARG::[G2]) ARG::[G2])::[G2]}.
    \item \mintinline[fontsize=\small, breaklines]{haskell}{(((if ARG::Bool) ARG::[G2]) []::[G2])::[G2]}.
    \item \mintinline[fontsize=\small, breaklines]{haskell}{(((if ARG::Bool) []::[G2]) []::[G2])::[G2]}.
    \item \mintinline[fontsize=\small, breaklines]{haskell}{(((if (null ARG::[T1])::Bool) []::[G2]) []::[G2])::[G2]}.
    \item \mintinline[fontsize=\small, breaklines]{haskell}{(((if (null (tail ARG::[T1])::T1)::Bool) []::[G2]) []::[G2])::[G2]}.
    \item \mintinline[fontsize=\small, breaklines]{haskell}{(((if (null (tail l::[G1])::G1)::Bool) []::[G2]) []::[G2])::[G2]}.
    \end{enumerate}
\end{frame}
