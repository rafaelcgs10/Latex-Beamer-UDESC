...
\begin{frame}[fragile]
  ...
  \item Completude (\textit{Completeness}): Se o sistema Damas-Milner mostra que
...
\begin{frame}[fragile]
  ...
  \begin{small}
  \begin{itemize}
  \item A substituição de renomeação é uma substituição com tais características em que:
    \begin{itemize}
...
\begin{itemize}
  ...
  \item \mintinline{coq}{Program} permiti que elementos da prova sejam postergados como obrigações de provas e a escrita do programa
