...
\begin{itemize}
  ...
  \item A maior dificuldade novamente é o caso do termo \textit{let}, que requer
        raciocínio sobre a criação de novas variáveis de tipo, as quais são definidas para tipos monomórficos
        (\mintinline{coq}{new_tv_ty}), para \textit{schemes} (\mintinline{coq}{new_tv_schm}), para contextos
