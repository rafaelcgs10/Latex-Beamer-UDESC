...
\begin{frame}[fragile]
  ...
  \item \textit{Ideally} a type inference algorithm must represent its type system defines. algoritmo de inferência deve \textit{representar} o que o seu sistema de tipos define.
...
\begin{frame}[fragile]
  \frametitle{Foundations - Damas-Milner and algoritmo W}
  \begin{itemize}
  \item \textit{Soundness}: O que o algoritmo W infere pode ser demostrado pelas regras de Damas-Milner.
  \item \textit{Completeness}: Se o sistema Damas-Milner mostra que
